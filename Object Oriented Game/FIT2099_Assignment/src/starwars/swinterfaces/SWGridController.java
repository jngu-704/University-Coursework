...
public class SWGridController implements GridController {
	...
	private static SWGridTextInterface ui; 
	 ...
	 */
	public SWGridController(SWWorld world, SWGrid newGrid) {
		this.grid = newGrid;
	...
	public static void setGrid(SWGrid grid) {
		SWGridTextInterface.setGrid(grid);
	}
