...
public class SWGrid extends Grid<SWLocation> {
    private List<SWGrid> allGrids = new ArrayList<SWGrid>();
	/**
	 ...
	 */
	public SWGrid(LocationMaker<SWLocation> factory, int column, int row) {
		super(column,row,factory);
	}
	

	public void add(SWGrid newGrid){
