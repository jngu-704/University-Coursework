...
/**
 * All <code>Entities</code> and <code>Actors</code> in the starwars client
...
public interface SWEntityInterface extends EntityInterface {
    ...
    /**
     * Returns a string symbol that represents this <code>SWEntity</code> or
     * <code>SWActor</code>.
     * <p>
     * The Views use this method to obtain the symbols that are used to query
     * for resources(images) and for display.
     * 
    ...
    /**
     * Sets the symbol of this <code>SWEntity</code> or <code>SWActor</code>
     * with a new string <code>string</code>.
     * <p>
    ...
    /**
     * Returns true if this <code>SWEntity</code> or <code>SWActor</code> has
     * the given capability <code>c</code>, false otherwise.
     * 
    ...
    /**
     * Returns the hitpoints of this <code>SWEntity</code> or
     * <code>SWActor</code>.
     * 
    ...
    /**
     * Method that reduces the <code>hitpoints</code> to insist damage on of
     * this
     * <code>SWEntity</code> or <code>SWActor</code>.
     * 
     * @param hitPoints the amount of <code>hitpoints</code> to be reduced
